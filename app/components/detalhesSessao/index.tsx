export const DetalheSessao = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto p-6 mt-6 text-white">
            <div className="text-cyan-400 hover:underline text-sm">
                ← Voltar para Pautas
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
                {pauta.sessoes.map((sessao) => (
                    ...
                    >
                        ...
                        <div className="inline-block bg-cyan-400 text-black font-bold px-3 py-1 rounded hover:bg-cyan-300 mt-4">Ver Detalhes</div>
                    </div>
                ))}
            </div>
        </div>
