...
export const PautasVotacao = ({ onNavigate }: Props) => {
        ...
        <div className="min-h-screen bg-zinc-900 text-white flex flex-col">
            <div className='container mx-auto p-6 flex-grow'>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mt-4 mb-6">
                    ...
                    <button
                        className='flex items-center gap-2 bg-cyan-400 hover:bg-cyan-300 text-black font-semibold px-4 py-2 rounded-md transition-colors'
                        onClick={() => onNavigate('novaPauta')}
                        ><PlusCircle className="h-5 w-5"/>Nova Pauta</button>
                </div>
